...
def get_dict(seq):
    with open('/home/yunpei/probiotics/model2/v2_fine_feature_list5-8.json', 'r') as f:
...
folder_path_0 = '/home/yunpei/probiotics/dataset/longest_Lactobacillus_probiotics'
label_0 = 0
...
folder_path_1 = '/home/yunpei/probiotics/dataset/longest_Bifidobacterium_probiotics'
label_1 = 1
...
lacto_feat_list = process_feat(seq_list_0, filename_list_0)
bifid_feat_list = process_feat(seq_list_1, filename_list_1)
other_feat_list = process_feat(seq_list_2, filename_list_2)

with open('./model2/v2_fine_feature_list5-8.tsv', 'w') as f:
    for feat_str in lacto_feat_list:
        f.write(str(label_0) + '\t' + feat_str + '\n')
    for feat_str in bifid_feat_list:
        f.write(str(label_1) + '\t' + feat_str + '\n')
    for feat_str in other_feat_list:
        f.write(str(label_2) + '\t' + feat_str + '\n')